...
class DownloadFragment : Fragment() {
    ...
    private val url =
        "https://cn.bing.com/th?id=OHR.IcelandicSummer_ZH-CN1779278033_1920x1080.jpg&rf=LaDigue_1920x1080.jpg"
        ...
        context?.apply {
            lifecycleScope.launch {
                val file = File(
                    ...
                    "d7bbe689-7bab-4db4-938f-24d5e4854302.png"
                )
                    ...
                    .collect {
                        when (it) {
                            ...
                            is DownloadStatus.Error -> {
                                Toast.makeText(context, "下载错误：${it.throwable}", Toast.LENGTH_SHORT)
                                    .show()
                            }
                            else -> {
